      ...
      <main className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
        <div className="text-center space-y-8 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
            ...
            <button className="w-full sm:w-auto px-8 py-4 rounded-full border border-purple-600 text-purple-100 font-semibold bg-purple-900/10 hover:bg-purple-900/30 transition-all shadow-[0_0_15px_rgba(147,51,234,0.3)]">
              Saiba Mais
            </button>
          </div>
        </div>

        {/* Features Grid - Cards com Borda Roxa Sempre Visível */}
